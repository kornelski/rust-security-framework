...
extern "C" {
    ...
    pub fn SSLSetALPNProtocols(context: SSLContextRef,
                               protocols: CFArrayRef) -> OSStatus;
    #[cfg(feature = "OSX_10_13")]
    pub fn SSLCopyALPNProtocols(context: SSLContextRef,
                                protocolArray: *mut CFArrayRef) -> OSStatus;
}
